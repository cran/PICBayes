...
phi1[area==i]<-yt
phi2[area==i]<-xt
log_f1<-sum(phi1[1:n1])-sum(te3*exp(xcov[1:n1,]%*%beta+phi1[1:n1]+phicoef2_trt[1:n1]*xtrt[1:n1]))+sum(phi1[(n1+1):N]*te1)-sum((exp(xcov[(n1+1):N,]%*%beta+phi1[(n1+1):N]+phicoef2_trt[(n1+1):N]*xtrt[(n1+1):N]))*te2)-0.5*tau*(yt^2)
log_f2<-sum(phi2[1:n1])-sum(te3*exp(xcov[1:n1,]%*%beta+phi2[1:n1]+phicoef2_trt[1:n1]*xtrt[1:n1]))+sum(phi2[(n1+1):N]*te1)-sum((exp(xcov[(n1+1):N,]%*%beta+phi2[(n1+1):N]+phicoef2_trt[(n1+1):N]*xtrt[(n1+1):N]))*te2)-0.5*tau*(xt^2)
num<-log_f1 #proposal dist is symmetric
den<-log_f2
...
phi1_trt[area==i]<-yt
phi2_trt[area==i]<-xt
log_f1<-sum(phi1_trt[1:n1]*xtrt[1:n1])-sum(te3*exp(xcov[1:n1,]%*%beta+phicoef2[1:n1]+phi1_trt[1:n1]*xtrt[1:n1]))+sum(phi1_trt[(n1+1):N]*xtrt[(n1+1):N]*te1)-sum(te2*exp(xcov[(n1+1):N,]%*%beta+phicoef2[(n1+1):N]+phi1_trt[(n1+1):N]*xtrt[(n1+1):N]))-0.5*tau_trt*(yt^2)
log_f2<-sum(phi2_trt[1:n1]*xtrt[1:n1])-sum(te3*exp(xcov[1:n1,]%*%beta+phicoef2[1:n1]+phi2_trt[1:n1]*xtrt[1:n1]))+sum(phi2_trt[(n1+1):N]*xtrt[(n1+1):N]*te1)-sum(te2*exp(xcov[(n1+1):N,]%*%beta+phicoef2[(n1+1):N]+phi2_trt[(n1+1):N]*xtrt[(n1+1):N]))-0.5*tau_trt*(xt^2)
num<-log_f1 #proposal dist is symmetric
den<-log_f2
